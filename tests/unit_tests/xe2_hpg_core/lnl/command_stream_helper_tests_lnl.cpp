...
TEST_F(CommandStreamerHelperTest, givenLnlAndMemoryAlignment4KbWhenCheckIsMemorySupportedThenOnlyForMemoryBankSystemIsReturnedTrue) {
...
TEST_F(CommandStreamerHelperTest, givenLnlAndMemoryAlignment64KbWhenCheckIsMemorySupportedThenOnlyForMemoryBankSystemIsReturnedTrue) {
    TEST_REQUIRES(gpu->productFamily == ProductFamily::Lnl);
    auto &rcs = gpu->getCommandStreamerHelper(defaultDevice, ENGINE_RCS);
...
TEST_F(CommandStreamerHelperTest, givenLnlAndMemoryAlignment1bWhenCheckIsMemorySupportedThenReturnFalse) {
    TEST_REQUIRES(gpu->productFamily == ProductFamily::Lnl);
    auto &rcs = gpu->getCommandStreamerHelper(defaultDevice, ENGINE_RCS);
    auto pageSize = 1u;
