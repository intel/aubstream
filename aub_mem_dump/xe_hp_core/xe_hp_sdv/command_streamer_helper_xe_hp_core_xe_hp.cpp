...
struct GpuXeHpSdv : public GpuXeHpCore {
    ...
    bool requireLocalMemoryForPageTables() const override {
        return true;
    }
    ...
    const MMIOList getGlobalMMIO() const override {
        const MMIOList globalMMIO = {
            ...
            // LNCF_MOCS (XEHP only)
            MMIOPair(0x0000B020, 0x00900000), //LNCF0 - Lower: Error (Reserved for Non-Use), Upper: UC (Coherent; GO:L3)
            MMIOPair(0x0000B024, 0x005000D0), //LNCF1 - Lower: UC (Coherent; GO:Memory),     Upper: UC (Non-Coherent*; GO:Memory)
            MMIOPair(0x0000B028, 0x00B00010), //LNCF2 - Lower: UC (Non-Coherent*; GO:L3),    Upper: L3
            ...
            MMIOPair(0x0000B080, 0x009000B0), //LNCF24 - Lower: HDC:L1 + L3,                  Upper: HDC:L1
